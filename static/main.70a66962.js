              ...
              if (u) {
                ...
                (a =
                  "bottom" == a && c.bottom + f > h.bottom
                    ...
                    : "top" == a && c.top - f < h.top
                    ? "bottom"
                    : "right" == a && c.right + p > h.width
                    ? "left"
                    : "left" == a && c.left - p < h.left
                    ? "right"
                    : a),
    ...
    !(function (e, n) {
        ...
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
          (i = t[r]),
            i.style &&
              ...
              e
                ? ("none" === n &&
                    ((o[r] = Ht.get(i, "display") || null),
                    o[r] || (i.style.display = "")),
                  "" === i.style.display && zt(i) && (o[r] = x(i)))
                : "none" !== n && ((o[r] = "none"), Ht.set(i, "display", n)));
      ...
      function O(t, e) {
        ...
        if (1 === e.nodeType) {
          if (
            Ht.hasData(t) &&
            ((r = Ht.access(t)), (s = Ht.set(e, r)), (u = r.events))
          ) {
          ...
          Ft.hasData(t) &&
            ((a = Ft.access(t)), (l = yt.extend({}, a)), Ft.set(e, l));
        }
      }
      function I(t, e) {
      ...
      function P(t, e, n, i) {
        ...
        if (
          g ||
          (f > 1 && "string" == typeof h && !vt.checkClone && re.test(h))
        )
        ...
        if (
          f &&
          ((o = k(e, t[0].ownerDocument, !1, t, i)),
          (r = o.firstChild),
          1 === o.childNodes.length && (o = r),
          r || i)
        ) {
          for (a = yt.map(T(o, "script"), A), l = a.length; p < f; p++)
            (u = o),
              p !== d &&
          ...
          if (l)
            for (
              c = a[a.length - 1].ownerDocument, yt.map(a, j), p = 0;
              p < l;
              p++
            )
              (u = a[p]),
      ...
      function B(t, e, n, i, o) {
        ...
        for (
          ...
          "margin" === n && (s += yt.css(t, n + Ut[r], !0, o)),
            i
              ? ("content" === n && (s -= yt.css(t, "padding" + Ut[r], !0, o)),
                "margin" !== n &&
                  (s -= yt.css(t, "border" + Ut[r] + "Width", !0, o)))
              : ((s += yt.css(t, "padding" + Ut[r], !0, o)),
                "padding" !== n &&
                  (s += yt.css(t, "border" + Ut[r] + "Width", !0, o)));
        return s;
      }
      ...
      function V(t, e) {
        ...
        for (e = e ? 1 : 0; i < 4; i += 2 - e)
          (n = Ut[i]), (o["margin" + n] = o["padding" + n] = t);
      ...
      var Ct = (function (t) {
        function e(t, e, n, i) {
          ...
          if (
            !i &&
            ((e ? e.ownerDocument || e : F) !== j && A(e), (e = e || j), I)
          ) {
            if (11 !== h && (l = gt.exec(t)))
              if ((o = l[1])) {
                if (9 === h) {
          ...
          return (
            ...
            i(function (i, s, a, l) {
              var u,
                ...
                b = n ? (r || (i ? t : m || o) ? [] : s) : y;
              if ((n && n(y, b, a, l), o))
                for (u = g(b, d), o(u, [], a, l), c = u.length; c--; )
                  (p = u[c]) && (b[d[c]] = !(y[d[c]] = p));
              if (i) {
                if (r || t) {
                  if (r) {
          ...
          var o = n.length > 0,
            ...
            s = function (i, s, a, l, u) {
              ...
              for (
                ...
                if (r && c) {
                  for (
                    p = 0, s || c.ownerDocument === j || (A(c), (a = !I));
                    (f = t[p++]);
        ...
        try {
          G.apply((Y = K.call(F.childNodes)), F.childNodes),
                  ...
                  ? function (t, e) {
                      ...
                      return (
                        ...
                        (!x.sortDetached && e.compareDocumentPosition(t) === n)
                          ? t === j || (t.ownerDocument === F && R(F, t))
                            ? -1
                            : e === j || (e.ownerDocument === F && R(F, e))
                            ? 1
                            : D
                            ? J(D, t) - J(D, e)
                            : 0
                  ...
                  return yt
                    .Deferred(function (n) {
                      e[0][3].add(
                        ...
                        e[2][3].add(r(0, n, yt.isFunction(i) ? i : d));
                    })
                    .promise();
                },
                promise: function (t) {
        ...
        yt.extend({
          ...
          ready: function (t) {
            (!0 === t ? --yt.readyWait : yt.isReady) ||
              ((yt.isReady = !0),
              (!0 !== t && --yt.readyWait > 0) || Lt.resolveWith(st, [yt]));
          },
        }),
          ...
          queue: function (t, e, n) {
            ...
            if (t)
              return (
                ...
                n &&
                  (!i || Array.isArray(n)
                    ? (i = Ht.access(t, e, yt.makeArray(n)))
                    : i.push(n)),
                i || []
              );
          },
              ...
              if (
                ...
                s &&
                  ...
                  ((p.teardown && !1 !== p.teardown.call(t, h, m.handle)) ||
                    yt.removeEvent(t, d, m.handle),
                  delete l[d]);
              } else for (d in l) yt.event.remove(t, d + e[u], n, i, !0);
          ...
          yt.cssHooks[e] = {
            ...
            set: function (t, n, i) {
              var o,
                ...
                s =
                  i &&
                  B(t, e, i, "border-box" === yt.css(t, "boxSizing", !1, r), r);
              return (
                s &&
                  (o = _t.exec(n)) &&
                  "px" !== (o[3] || "px") &&
          ...
          propHooks: {
            tabIndex: {
              get: function (t) {
                ...
                return e
                  ? parseInt(e, 10)
                  : Ce.test(t.nodeName) || (ke.test(t.nodeName) && t.href)
                  ? 0
                  : -1;
              },
            },
        ...
        trigger: function (t, e, i, o) {
          ...
          if (
            ...
            if (!o && !p.noBubble && !yt.isWindow(i)) {
              for (
                l = p.delegateType || d, Se.test(l + d) || (s = s.parentNode);
                s;
                s = s.parentNode
              )
                f.push(s), (a = s);
            ...
            for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
              (t.type = r > 1 ? l : p.bindType || d),
                (c =
                  (Ht.get(s, "events") || {})[t.type] && Ht.get(s, "handle")),
                c && c.apply(s, e),
                (c = u && s[u]) &&
                  c.apply &&
                  Rt(s) &&
          ...
          yt.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
            ...
            yt.event.special[e] = {
              ...
              teardown: function () {
                ...
                o
                  ? Ht.access(i, e, o)
                  : (i.removeEventListener(t, n, !0), Ht.remove(i, e));
              },
            };
          });
      var $e = n.location,
        ...
        yt.extend({
          ...
          ajax: function (t, e) {
                ...
                u
                  ? (h.ifModified &&
                    ...
                    204 === t || "HEAD" === h.type
                      ...
                      : 304 === t
                      ? (T = "notmodified")
                      : ((T = x.state), (f = x.data), (d = x.error), (u = !d)))
                  : ((d = T), (!t && T) || ((T = "error"), t < 0 && (t = 0))),
                (C.status = t),
                (C.statusText = (e || T) + ""),
                u ? v.resolveWith(g, [f, T, C]) : v.rejectWith(g, [C, T, d]),
                C.statusCode(b),
                (b = void 0),
                p &&
                  m.trigger(u ? "ajaxSuccess" : "ajaxError", [C, h, u ? f : d]),
                y.fireWith(g, [C, T]),
                p &&
            ...
            (p = yt.event && h.global),
              ...
              h.hasContent
                ...
                : ((d = h.url.slice(r.length)),
                  h.data &&
                    ((r += (Ne.test(r) ? "&" : "?") + h.data), delete h.data),
                  !1 === h.cache &&
                    ((r = r.replace(qe, "$1")),
                    (d = (Ne.test(r) ? "&" : "?") + "_=" + De++ + d)),
                  (h.url = r + d)),
            ...
            if (
              ...
              if (((C.readyState = 1), p && m.trigger("ajaxSend", [C, h]), c))
                return C;
              h.async &&
                h.timeout > 0 &&
      ...
      yt.ajaxSetup({
        ...
        yt.each(["top", "left"], function (t, e) {
          yt.cssHooks[e] = R(vt.pixelPosition, function (t, n) {
            if (n)
              return (n = q(t, e)), ue.test(n) ? yt(t).position()[e] + "px" : n;
          });
        }),
